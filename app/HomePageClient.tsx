...
<section className="rounded-[1.5rem] bg-white/95 p-6 shadow-sm md:p-8">
  <div className="mx-auto max-w-6xl">
    ...
    <div className="mt-6 rounded-3xl border border-amber-200 bg-white p-6 text-center shadow-sm">
      ...
      <Link href="/celebration-of-life-slideshow/create" className="mt-5 inline-flex min-h-14 items-center justify-center rounded-full bg-blue-950 px-7 py-3 text-base font-bold text-white hover:bg-blue-900">Create a Standalone Presentation</Link>
    </div>
  </div>
</section>
