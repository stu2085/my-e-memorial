        ...
        <section className="rounded-3xl bg-white p-8 shadow-sm">
          <div className="flex flex-col justify-between gap-5 md:flex-row md:items-start">
            ...
            <a
              ...
              className="w-fit rounded-full border border-stone-300 bg-white px-5 py-2 text-base font-semibold text-stone-700 transition hover:bg-stone-50"
            >
              Back to Campaigns
            </a>
          </div>
...
<div className="grid gap-4 md:grid-cols-2">
  ...
  <div className="mt-4">
    ...
    <button
      ...
      className="mt-4 rounded-full border border-red-300 bg-white px-5 py-2 text-base font-semibold text-red-700 transition hover:bg-red-50"
    >
      Remove Current Media
            ...
            {campaign.media_type === "video" && (
              <div>
                ...
                <p className="mb-3 text-base leading-6 text-stone-600">
        ...
        <section className="mt-8 rounded-3xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <button
              ...
              className="rounded-full border border-stone-300 bg-white px-6 py-3 text-base font-semibold text-stone-700 transition hover:bg-stone-50 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isSaving
                ? "Saving..."
                : "Save Changes"}
            ...
            {!campaign.is_published ? (
              <button
                ...
                className="rounded-full bg-green-700 px-6 py-3 text-base font-semibold text-white transition hover:bg-green-600 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {isSaving
                  ? "Publishing..."
                  : "Publish Campaign"}
              ...
              <>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-full bg-stone-900 px-6 py-3 text-base font-semibold text-white transition hover:bg-stone-700"
                >
                  View Live Page
                </a>
                ...
                <button
                  ...
                  className="rounded-full border border-red-300 bg-white px-6 py-3 text-base font-semibold text-red-700 transition hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  Unpublish
                </button>
              </>
