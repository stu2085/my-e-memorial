...
setIsSubmitting(false);
  ...
  <div className="grid grid-cols-1 gap-6">
    ...
    />
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="block w-full rounded-2xl border border-stone-300 px-4 py-3 text-base text-stone-700"
                  />
                  <PhotoGrid
            ...
            {successMessage && (
              <div className="rounded-2xl border border-green-200 bg-green-50 px-4 py-3 text-base text-green-700">
                {successMessage}
              </div>
            )}
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="rounded-full bg-stone-900 px-6 py-3 text-base font-semibold text-white transition hover:bg-stone-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
              ...
              <button
                ...
                className="rounded-full border border-stone-300 bg-white px-6 py-3 text-base font-semibold text-stone-700 transition hover:bg-stone-50"
              >
                Cancel
              </button>
            </div>
...
function Input({
  ...
  return (
    <div>
      <label className="mb-2 block text-base font-semibold text-stone-800">{label}</label>
      <input
        type={type}
        name={name}
        value={value}
...
function PhotoGrid({
  ...
  if (photos.length === 0) {
    return <p className="mt-2 text-base text-stone-500">No photos yet.</p>;
  }
      ...
      {photos.map((photo, index) => (
        ...
        >
          ...
          <button
            ...
            className="w-full border-t border-stone-200 px-3 py-2 text-base font-medium text-stone-700 hover:bg-stone-50"
          >
            Remove
          </button>
        </div>
