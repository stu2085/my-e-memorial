...
<div className="mx-auto grid w-full max-w-[1500px] grid-cols-1 gap-8 px-4 lg:grid-cols-[180px_minmax(0,900px)_180px] lg:justify-center">
  ...
  <Link
    ...
    className="mt-5 inline-flex items-center justify-center rounded-full bg-stone-900 px-6 py-3 text-base font-semibold text-white hover:bg-stone-700"
  >
    Log In
  </Link>
)}
          ...
          <>
            ...
            >
              ...
              <div className="relative z-10 px-8 py-10 text-white md:px-10 md:py-12">
                <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
                  <div>
                    <p className="text-base font-semibold uppercase tracking-[0.35em] text-stone-200">
                      Edit Memorial
                    </p>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Link
                      ...
                      className="inline-flex items-center justify-center rounded-full border border-white/40 bg-white/10 px-5 py-3 text-base font-semibold text-white shadow-sm backdrop-blur-sm transition hover:-translate-y-0.5 hover:bg-white/20"
                    >
                      Back to Memorial
                    </Link>
                  </div>
            ...
            <section className="overflow-hidden rounded-[2rem] border border-stone-200/80 bg-white shadow-[0_10px_30px_rgba(0,0,0,0.06)]">
              <div className="p-8 md:p-10 lg:p-12">
                {errorMessage && (
                  <div className="mb-6 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-base text-red-700">
                    {errorMessage}
                  </div>
                )}
