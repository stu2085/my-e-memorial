...
export default function CemeteryClient() {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="overflow-hidden rounded-3xl bg-white shadow-sm">
          <div className="relative h-[260px] w-full">
            ...
            <div className="absolute inset-0 flex items-end">
              <div className="p-8 text-white">
                <p className="text-base font-semibold uppercase tracking-[0.2em] text-stone-200">
                  Cemetery Page
                </p>
          ...
          <div className="grid gap-6 p-8 lg:grid-cols-3">
            <div className="rounded-3xl border border-stone-200 bg-stone-50 p-6">
              ...
              <div className="mt-5 space-y-3 text-base text-stone-700">
                <p>
        ...
        <section className="mt-8 rounded-3xl bg-white p-8 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <Link
              href="/search"
              className="rounded-full border border-stone-300 px-5 py-2 text-base font-semibold text-stone-700 hover:bg-stone-100"
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-4 grid grid-cols-1 gap-2 text-base text-stone-700 sm:grid-cols-2">
                      ...
                      <div className="mt-5 inline-flex rounded-full bg-stone-900 px-4 py-2 text-base font-semibold text-white">
                        View Memorial
                      </div>
                    </div>
                  </Link>
