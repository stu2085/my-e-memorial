...
export default function BetaCodesAdminClient() {
...
if (form.assignedEmail.trim()) {
  ...
  <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
    ...
    <a
      ...
      className="w-fit rounded-full bg-stone-900 px-6 py-3 text-base font-semibold text-white transition hover:bg-stone-700"
    >
      Social Campaigns
    </a>
  </div>
          ...
          {message && (
            <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-base text-amber-800">
              {message}
            </div>
          )}
          ...
          <form onSubmit={handleCreate} className="mt-8 grid gap-5 md:grid-cols-2">
            ...
            <div className="flex items-end">
              <button
                ...
                className="rounded-full border border-stone-300 bg-white px-5 py-3 text-base font-semibold text-stone-700 hover:bg-stone-50"
              >
                Generate Code
              </button>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-2xl border border-stone-300 bg-white px-4 py-3 text-base text-stone-900 outline-none focus:border-stone-500"
              />
            </div>
            ...
            <div className="md:col-span-2">
              <button
                type="submit"
                className="rounded-full bg-stone-900 px-6 py-3 text-base font-semibold text-white hover:bg-stone-700"
              >
                Create Promo Code
              </button>
            </div>
                  ...
                  <tr key={code.id} className="border-b border-stone-100">
                    ...
                    <td className="py-3 pr-4">
                      <button
                        ...
                        className="rounded-full border border-stone-300 px-4 py-2 text-base font-semibold hover:bg-stone-50"
                      >
