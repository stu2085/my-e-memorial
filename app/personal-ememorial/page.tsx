...
const plans = [
  ...
  },
  {
    name: "Basic",
    price: "$49.95",
    description: "Unlock the full core Personal E-Memorial experience.",
    features: [
      "Up to 50 photos",
      ...
      "Newspaper and article memories",
      "Contributors",
      "QR code download",
    ],
  },
  {
    name: "Plus",
    price: "$69.95",
    description: "More room for photos, video, memories, and family history.",
    features: [
      "Up to 150 photos",
