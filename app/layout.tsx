...
/>
  ...
  <footer className="border-t border-stone-200 bg-white px-4 py-6 text-center text-base text-stone-500 sm:px-10">
    <div className="mx-auto flex max-w-5xl flex-wrap justify-center gap-x-4 gap-y-3">
      <Link href="/privacy" className="whitespace-nowrap hover:text-stone-800">Privacy Policy</Link>
      <Link href="/terms" className="whitespace-nowrap hover:text-stone-800">Terms of Service</Link>
      <Link href="/content-removal" className="whitespace-nowrap hover:text-stone-800">Content Removal</Link>
      <Link href="/dmca" className="whitespace-nowrap hover:text-stone-800">Copyright & DMCA</Link>
      <Link href="/refund-policy" className="whitespace-nowrap hover:text-stone-800">Refund Policy</Link>
       <Link href="/our-story" className="whitespace-nowrap hover:text-stone-800">
      Our Story
    </Link>
      <Link href="/contact" className="whitespace-nowrap hover:text-stone-800">Contact Us</Link>
      <Link
