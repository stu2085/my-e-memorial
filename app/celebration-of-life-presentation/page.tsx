...
export const metadata: Metadata = {
  ...
  description:
    "Create a Celebration of Life Presentation with photos, videos, and music. Preview as you build, then share your standalone presentation for 60 days with a one-time $19.95 purchase.",
};
    ...
    <main className="bg-[#f9f5eb] text-[#173a31]">
      ...
      >
        <div className="mx-auto max-w-4xl rounded-[2rem] border border-[#d9cbb0] bg-[#fffcf5]/95 px-6 py-10 text-center shadow-xl shadow-[#38483d]/15 backdrop-blur-sm sm:px-12 sm:py-14">
          ...
          <p className="mt-4 text-base text-[#344f43]">Create and preview before purchasing.</p>
        </div>
      </section>
