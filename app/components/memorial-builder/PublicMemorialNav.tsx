...
export type PublicMemorialNavItem = {
  id: string;
  title: string;
  disabled?: boolean;
  hidden?: boolean;
...
type PublicMemorialNavProps = {
  chapters: PublicMemorialNavItem[];
    ...
    case "family-and-friends":
      return (
        <svg {...common}>
          ...
          <path d="M3.5 19c.5-3.6 2.1-5.4 4.5-5.4 1.7 0 3 .8 4 2.3" />
          <path d="M20.5 19c-.5-3.6-2.1-5.4-4.5-5.4-1.7 0-3 .8-4 2.3" />
          <path d="M12 20s-3.2-1.8-3.2-4.4c0-1.2.9-2.1 2-2.1.7 0 1.1.3 1.2.7.1-.4.5-.7 1.2-.7 1.1 0 2 .9 2 2.1C15.2 18.2 12 20 12 20Z" />
        </svg>
      );
    case "obituary":
      return (
...
export default function PublicMemorialNav({
  chapters,
  currentChapterId,
  onChapterSelect,
}: PublicMemorialNavProps) {
  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div
          ref={scrollerRef}
          className="overflow-x-auto scroll-smooth lg:overflow-visible [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
        >
          <div
            className="flex min-w-max items-stretch pl-4 pr-12 sm:pl-6 lg:grid lg:min-w-0 lg:px-0"
            style={{
              gridTemplateColumns: `repeat(${Math.max(1, visibleChapters.length)}, minmax(0, 1fr))`,
            }}
          >
            {visibleChapters.map((chapter) => {
              ...
              return (
                <button
                  ...
                  className={[
                    "relative flex w-[100px] shrink-0 flex-col items-center justify-start border-r border-stone-200 px-2 pb-3 pt-3 text-center transition lg:w-auto lg:min-w-0",
                    isCurrent
        ...
        {canScrollLeft ? (
          <button
            ...
            className="absolute inset-y-0 left-0 flex w-11 items-center justify-center border-r border-stone-200 bg-white/95 text-blue-950 shadow-[8px_0_14px_rgba(255,255,255,0.92)] transition hover:bg-stone-50 lg:hidden"
          >
            <svg
              aria-hidden="true"
              width="26"
        ...
        {canScrollRight ? (
          <button
            ...
            className="absolute inset-y-0 right-0 flex w-11 items-center justify-center border-l border-stone-200 bg-white/95 text-blue-950 shadow-[-8px_0_14px_rgba(255,255,255,0.92)] transition hover:bg-stone-50 lg:hidden"
          >
            <svg
              aria-hidden="true"
              width="26"
