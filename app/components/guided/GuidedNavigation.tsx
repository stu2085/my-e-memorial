    ...
    <div className="mt-8 border-t border-stone-200 pt-6">
      <div className="mb-5 flex items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={isSaving}
          className="text-sm font-semibold text-stone-600 underline-offset-4 transition hover:text-stone-900 hover:underline disabled:cursor-not-allowed disabled:opacity-50"
        >
